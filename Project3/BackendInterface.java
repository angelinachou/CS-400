...
public interface BackendInterface {
   ...
   * ordered by the songs' year, and fall within the specified range of year values. This year range
   * will also be used by future calls to filterSongs and getFiveMost.
   *
   ...
   * understood to be unbounded. For example, a argument for the hight parameter means that there is
   * no maximum year to include in the returned list.
   *
