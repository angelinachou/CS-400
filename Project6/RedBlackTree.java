...
import P106SubmissionChecker.RBTNode;
...
public class RedBlackTree<T extends Comparable<T>> extends BSTRotation<T> {
  ...
  protected void ensureRedProperty(RBTNode<T> newNode) {
    ...
    RBTNode<T> sibling =
        (grandparent.childLeft() == parent) ? grandparent.childRight() : grandparent.childLeft();
  ...
  private void case3(RBTNode<T> child) {
    ...
    // child becomes parent of the parent node, so have to figure out where the parent is and call
    // case2 through there
    if (child.parent() != null) {
  ...
  public void Test1() {
    ...
    // 1 should create a double red, which would then need to be addressed by making the sibling and
    // parent nodes black.
    rbt.insert(1);
    assertTrue(!((RBTNode<Integer>) rbt.root).isRed);
  ...
  /**
   * Test2 tests case 2 with the most basic possible red black tree. Since this one requires
   * rotation, I also made sure that all the characters were shifted to the correct place.
   */
  @Test
  public void Test2() {
    ...
    assertTrue(
        !((RBTNode<Character>) rbt.root).isRed && ((RBTNode<Character>) rbt.root).data == 'C');
    assertTrue(((RBTNode<Character>) rbt.root.childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight()).data == 'D');
    assertTrue(((RBTNode<Character>) rbt.root.childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft()).data == 'A');
    assertTrue(!((RBTNode<Character>) rbt.root.childRight().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childRight()).data == 'E');
  }

  /**
   * Test3 tests case 3 with the most basic possible red black tree. Since this one requires
   * rotation, I also made sure that all the characters were shifted to the correct place.
   */
  @Test
  public void Test3() {
    ...
    assertTrue(
        !((RBTNode<Character>) rbt.root).isRed && ((RBTNode<Character>) rbt.root).data == 'C');
    assertTrue(((RBTNode<Character>) rbt.root.childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft()).data == 'B');
    assertTrue(((RBTNode<Character>) rbt.root.childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight()).data == 'D');
    assertTrue(!((RBTNode<Character>) rbt.root.childRight().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childRight()).data == 'E');
  ...
  public void Test4() {
    ...
    assertTrue(
        !((RBTNode<Character>) rbt.root).isRed && ((RBTNode<Character>) rbt.root).data == 'K');
    assertTrue(((RBTNode<Character>) rbt.root.childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft()).data == 'F');
    assertTrue(!((RBTNode<Character>) rbt.root.childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight()).data == 'R');
    assertTrue(!((RBTNode<Character>) rbt.root.childLeft().childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft().childLeft()).data == 'D');
    assertTrue(!((RBTNode<Character>) rbt.root.childLeft().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft().childRight()).data == 'H');
    assertTrue(((RBTNode<Character>) rbt.root.childRight().childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childLeft()).data == 'O');
    assertTrue(((RBTNode<Character>) rbt.root.childRight().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childRight()).data == 'T');
    assertTrue(((RBTNode<Character>) rbt.root.childLeft().childRight().childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft().childRight().childLeft()).data == 'G');
    assertTrue(((RBTNode<Character>) rbt.root.childLeft().childRight().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft().childRight().childRight()).data == 'I');

    // this is where we insert the new letter J
    rbt.insert('J');

    // checking that all the nodes and colors are correct after the insertion and rotations and
    // color flipping
    assertTrue(
        !((RBTNode<Character>) rbt.root).isRed && ((RBTNode<Character>) rbt.root).data == 'H');
    assertTrue(((RBTNode<Character>) rbt.root.childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft()).data == 'F');
    assertTrue(((RBTNode<Character>) rbt.root.childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight()).data == 'K');
    assertTrue(!((RBTNode<Character>) rbt.root.childLeft().childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft().childLeft()).data == 'D');
    assertTrue(!((RBTNode<Character>) rbt.root.childLeft().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childLeft().childRight()).data == 'G');
    assertTrue(!((RBTNode<Character>) rbt.root.childRight().childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childLeft()).data == 'I');
    assertTrue(!((RBTNode<Character>) rbt.root.childRight().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childRight()).data == 'R');
    assertTrue(((RBTNode<Character>) rbt.root.childRight().childLeft().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childLeft().childRight()).data == 'J');
    assertTrue(((RBTNode<Character>) rbt.root.childRight().childRight().childLeft()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childRight().childLeft()).data == 'O');
    assertTrue(((RBTNode<Character>) rbt.root.childRight().childRight().childRight()).isRed
        && ((RBTNode<Character>) rbt.root.childRight().childRight().childRight()).data == 'T');
  }
}
