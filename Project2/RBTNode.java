...
public class RBTNode<T> extends BinaryTreeNode<T> {
  ...
  /**
   * Overrides the childLeft() method from BinaryTreeNode so that child reference is returned as an
   * RBTNode and does not need to be casted.
   */
  @Override
  ...
  /**
   * Overrides the childRight() method from BinaryTreeNode so that child reference is returned as an
   * RBTNode and does not need to be casted.
   */
  @Override
  ...
  /**
   * Overrides the parent() method from BinaryTreeNode so that child reference is returned as an
   * RBTNode and does not need to be casted.
   */
  @Override
